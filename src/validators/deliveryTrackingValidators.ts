...
export const validateUpdateTrackingStatus = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  }).or("status", "trackingNumber", "courierName", "courierWebsite", "estimatedDeliveryDate");
...
export const validateAddTrackingDetails = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
